...
| 波特率 | 115200 |
| 关节限位 | base/left/right: 0-180°, claw: 0-90° |
| 回零位 | base=90, left=90, right=90, claw=25 |
| 夹爪映射 | clawPhysical(cmd) = 180 - 2*cmd (cmd=0→闭合, 90→全开) |
...
*Generated on 2026-06-16 · MeArm Workbench v1.0*
