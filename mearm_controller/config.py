...
- class_name: 若用户说了物体名(杯子/苹果/瓶子/书等), 填英文类名(cup/apple/bottle/book等), 否则 null
...
# YOLO 检测帧间隔: 每 N 帧跑一次 YOLO, 其余帧复用上次结果 (1=每帧都跑)
YOLO_FRAME_INTERVAL = 3
# COCO 80类中常用物体的中文名 (仅列出桌面常见物体, 其余用英文名)
YOLO_CLASS_CN: dict[str, str] = {
    ...
    "cake": "蛋糕", "donut": "甜甜圈", "sandwich": "三明治",
    "hot dog": "热狗",
    # 桌面物品
